...
#ifndef __IMX412_TABLES__
#define __IMX412_TABLES__

/**
 * Image sensor registers as described in the IMX412 register map
 */
...
static const imx412_reg mode_4056x3040[] = {
    ...
    {FRM_LENGTH_LINES_HIGH,      (IMX412_DEFAULT_HEIGHT + IMX412_MIN_FRAME_LENGTH_DELTA) >> 8},
    {FRM_LENGTH_LINES_LOW,       (IMX412_DEFAULT_HEIGHT + IMX412_MIN_FRAME_LENGTH_DELTA) & 0xFF},
    {SCALE_MODE,                 0x00},
...
static const imx412_reg mode_3840x2160[] = {
    ...
    {FRM_LENGTH_LINES_HIGH,      (IMX412_CROP_3840x2160_HEIGHT + IMX412_MIN_FRAME_LENGTH_DELTA) >> 8},
    {FRM_LENGTH_LINES_LOW,       (IMX412_CROP_3840x2160_HEIGHT + IMX412_MIN_FRAME_LENGTH_DELTA) & 0xFF},
    {SCALE_MODE,                 0x00},
...
static const imx412_reg mode_crop_binning_h2v2[] = {
    ...
    {FRM_LENGTH_LINES_HIGH,     (IMX412_MODE_CROP_BINNING_H2V2_HEIGHT + IMX412_MIN_FRAME_LENGTH_DELTA) >> 8},
    {FRM_LENGTH_LINES_LOW,      (IMX412_MODE_CROP_BINNING_H2V2_HEIGHT + IMX412_MIN_FRAME_LENGTH_DELTA) & 0xFF},
    {SCALE_MODE,                0x00},
    ...
    {Y_ADD_END_LOW,             (440 + IMX412_MODE_CROP_BINNING_H2V2_HEIGHT*2 - 1) & 0xFF},
...
static const struct camera_common_frmfmt imx412_frmfmt[] = {
    ...
    {
        .size = {IMX412_MODE_CROP_BINNING_H2V2_WIDTH, IMX412_MODE_CROP_BINNING_H2V2_HEIGHT},
