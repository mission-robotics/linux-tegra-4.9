/*
 * imx335_mode_tbls.h - imx335 sensor mode tables
 *
...
#ifndef __IMX335_TABLES__
#define __IMX335_TABLES__

/**
 * Image sensor registers as described in the IMX335 register map
 */
...
/**
 * Minimal value of frame length is resolution height + 96
 * Minimal value for scaling modes is full pixel mode height + 96
 *
