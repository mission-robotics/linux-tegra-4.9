/*
 * imx464_mode_tbls.h - imx464 sensor mode tables
 *
 * According to the documentations:
 *      IMX464LQR-C ver. E20405
 *      IMX464 Support Package ver. 1.0
 *      Additional Function of Synchronizing Sensors ver. 1.0
 *      Global Reset Mode ver. 1.0
 *
...
#ifndef __IMX464_TABLES__
#define __IMX464_TABLES__

/**
 * Image sensor registers as described in the IMX464 register map
 */
...
static const imx464_reg imx464_start[] = {
    ...
    {STANDBY,              0x00},
    /* After standby canceled - internal regulator stabilization 18 ms or more */
