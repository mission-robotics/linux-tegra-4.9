...
#ifndef __IMX585_TABLES__
#define __IMX585_TABLES__

/**
 * Image sensor registers as described in the IMX585 register map
 */
...
static const imx585_reg imx585_init_settings[] = {
    ...
    {LANEMODE,  0x03},
    {INCK_SEL,  0x01},
    {0x303A,    0x01}, // disabled embedded data
