/*
 * imx565_mode_tbls.h - imx565 sensor mode tables
 *
 * According to the documentations:
 *      IMX565-AAMJ-C Datasheet rev. E20Z05A12
 *      IMX565-AAMJ Register Map rev. JE20Z05_2.0
 *      IMX530series_IMX540series_IMX535series_IMX545series_IMX565series Support Package rev. 2.1
 *
...
#ifndef __IMX565_TABLES__
#define __IMX565_TABLES__

/**
 * Image sensor registers as described in the IMX565 register map
 */
...
/**
 * Minimal value of frame length is resolution height + 116
 * Minimal value for scaling modes is full pixel mode height + 116
 *
...
static const int imx565_205fps[] = {
    205
};
