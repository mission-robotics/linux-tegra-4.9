/*
 * imx530_mode_tbls.h - imx530 sensor mode tables
 *
...
#ifndef __IMX530_TABLES__
#define __IMX530_TABLES__

/**
 * Image sensor registers as described in the IMX530 register map
 */
...
#define IMX530_ROI_MODE_WIDTH       4512
#define IMX530_ROI_MODE_HEIGHT      4512

#define IMX530_ROI_MODE_2_WIDTH       5328
#define IMX530_ROI_MODE_2_HEIGHT      3040

#define IMX530_ROI_MODE_3_WIDTH       4064
#define IMX530_ROI_MODE_3_HEIGHT      3008
...
/**
 * Minimal value of frame length is resolution height + 128
 * Minimal value for scaling modes is full pixel mode height + 128
 *
...
static const imx530_reg mode_4064x3008[] = {
    ...
    {FID0_ROIWH1_LOW,   IMX530_TO_LOW_BYTE(IMX530_ROI_MODE_3_WIDTH)},
    {FID0_ROIWH1_HIGH,  IMX530_TO_MID_BYTE(IMX530_ROI_MODE_3_WIDTH)},
    
    {FID0_ROIWV1_LOW,   IMX530_TO_LOW_BYTE(IMX530_ROI_MODE_3_HEIGHT)},
    {FID0_ROIWV1_HIGH,  IMX530_TO_MID_BYTE(IMX530_ROI_MODE_3_HEIGHT)},
