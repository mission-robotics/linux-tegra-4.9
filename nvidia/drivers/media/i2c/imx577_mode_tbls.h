/*
 * imx577_mode_tbls.h - imx577 sensor mode tables
 *
...
#ifndef __IMX577_TABLES__
#define __IMX577_TABLES__

/**
 * Image sensor registers as described in the IMX577 register map
 */
...
static const imx577_reg mode_4056x3040[] = {
    ...
    {FRM_LENGTH_LINES_HIGH,      (IMX577_DEFAULT_HEIGHT + IMX577_MIN_FRAME_LENGTH_DELTA) >> 8},
    {FRM_LENGTH_LINES_LOW,       (IMX577_DEFAULT_HEIGHT + IMX577_MIN_FRAME_LENGTH_DELTA) & 0xFF},
    {SCALE_MODE,                 0x00},
...
static const imx577_reg mode_3840x2160[] = {
    ...
    {FRM_LENGTH_LINES_HIGH,      (IMX577_CROP_3840x2160_HEIGHT + IMX577_MIN_FRAME_LENGTH_DELTA) >> 8},
    {FRM_LENGTH_LINES_LOW,       (IMX577_CROP_3840x2160_HEIGHT + IMX577_MIN_FRAME_LENGTH_DELTA) & 0xFF},
    {SCALE_MODE,                 0x00},
...
static const imx577_reg mode_crop_binning_h2v2[] = {
    ...
    {FRM_LENGTH_LINES_HIGH,      (IMX577_MODE_CROP_BINNING_H2V2_HEIGHT + IMX577_MIN_FRAME_LENGTH_DELTA) >> 8},
    {FRM_LENGTH_LINES_LOW,       (IMX577_MODE_CROP_BINNING_H2V2_HEIGHT + IMX577_MIN_FRAME_LENGTH_DELTA) & 0xFF},
    {SCALE_MODE,                 0x00},
